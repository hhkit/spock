...
VkSubmitInfo2
vkinit::submit_info(VkCommandBufferSubmitInfo *cmd,
  ...
  info.waitSemaphoreInfoCount = waitSemaphoreInfo.size();
  info.pWaitSemaphoreInfos = waitSemaphoreInfo.data();

  info.signalSemaphoreInfoCount = signalSemaphoreInfo.size();
